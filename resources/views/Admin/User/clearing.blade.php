...
@section('content')
    ...
    <div class="content-wrapper" style="padding: 0;margin: 0">
        ...
        <div class="row" style="margin-top: 20px;">
            ...
            <div class="col-md-3 col-sm-8 col-xs-8" style="height: 756px;margin-left: 55px;">
                <div style="margin-bottom: 20px;background: #ffffff;width: 418px;margin-left: -15px;margin-top: 15px">
                ...
                <div style="height: 608px;width:418px;background: #ffffff;margin-left: -15px">
            ...
            <div class="col-md-7 col-xs-7" style="background: #ffffff;margin: 15px 60px">
