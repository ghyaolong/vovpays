                ...
                <div class="box-body" style="padding:20px auto;font-size: 15px;height: 200px">
                    <table class="table table-bordered" style="margin: 10px auto">
                        ...
                        <tr>
                            <td>1.</td>
                            <td>php demo</td>
                            <td><a class="glyphicon glyphicon-download-alt btn btn-primary" href="/demo/pay-php.rar" download="pay-php.rar"> 下载</a></td>
                        </tr>
                        <tr>
                            <td>2.</td>
                            <td>java demo</td>
                            <td><a class="glyphicon glyphicon-download-alt btn btn-primary" href="/demo/java-php.rar" download="java-php.rar"> 下载</a></td>
                        </tr>
                    </table>
                </div>
            </div>
                ...
                <div class="box-body" style="padding:20px auto;font-size: 15px;height: 200px">
                    <table class="table table-bordered" style="margin: 10px auto">
                        ...
                        <tr>
                            <td>1.</td>
                            <td>API文档</td>
                            <td><a class="glyphicon glyphicon-download-alt btn btn-primary" href="/demo/免签支付接口文档v1.1.docx" download="免签支付接口文档v1.1.docx"> 下载</a></td>
                        </tr>
                    </table>
                </div>
