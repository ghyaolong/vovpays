        ...
        <div class="col-md-8">
            <div class="box box-primary box-solid">
                ...
                <div class="box-body" class="col-md-12">
                    <!-- ./col -->
                    <form class="navbar-form navbar-left" action="{{route('court.accountBank',0)}}" method="get">
        ...
        <div class="modal-dialog" style="margin-top: 123px">
            <div class="modal-content">
                ...
                <div class="modal-body" style="overflow: auto;">
                    <form id="addForm" action="{{ route('court.accountBankAdd') }}" class="form-horizontal" role="form">
