                ...
                <div class="box-body">
                    <table id="example2" class="table table-condensed table-bordered table-hover">
                        ...
                        {{--@foreach($list as $court)--}}
                            <tr>
                                <td>{{ $court['merchant'] }}</td>
                                <td>{{ $court['username'] }}</td>
                                <td>{{ $court['quota'] }}</td>
                                <td>{{ $court['email'] }}</td>
                                <td>{{ $court['phone'] }}</td>
                                <td>
                                    <input class="switch-state" data-id="{{ $court['id'] }}" type="checkbox"
                                           @if($court['status'] == 1) checked @endif >
                                </td>
                                <td>
                                    <button type="button" class="btn btn-primary btn-sm"
                                            onclick="quota('上分',{{ $court['id'] }})">上分
                                    </button>
                                    <a href="{{ route('users.quotaLog', array('id'=>$court['id'])) }}" class="btn btn-success btn-sm">上分记录</a>
                                    <button type="button" class="btn btn-primary btn-sm"
                                            onclick="edit('会员编辑',{{ $court['id'] }})">编辑
                                    </button>
                                </td>
                            </tr>
                        {{--@endforeach--}}
