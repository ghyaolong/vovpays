...
<div class="body">
    ...
    <div class="mod-ct">
        ...
        <div class="amount" id="money">￥123213</div>
        <!--支付宝app支付-->
        <div class="paybtn" style="display: none;padding: 10px;">
            {{--alipays://platformapi/startapp?appId=20000123&actionType=scan&biz_data={"s": "money","u": "2088502872874704","a": "1","m": "1232"}--}}
        <a href='alipays://platformapi/startapp?saId=10000007&clientVersion=3.7.0.0718&qrcode=alipays://platformapi/startapp?appId=20000123&actionType=scan&biz_data={"s": "money","u": "2088502872874704","a": "1","m": "1232"}" id="alipaybtn' class="btn btn-primary" target="_blank">打开支付宝</a>
        </div>
        ...
        <div class="time-item">
            <div class="time-item"><h1>订单:12321321321</h1> </div>
...
<script type="text/javascript">
    ...
    $().ready(function(){
        ...
        // var strcode = toUtf8("http://v999h6.natappfree.cc/home2");
        // var qrcode = $('#show_qrcode').qrcode({ text: strcode });
        var qrcode = $('#show_qrcode').qrcode('alipays://platformapi/startapp?appId=20000123&actionType=scan&biz_data={"s": "money","u": "2088502872874704","a": "1","m": "1232"}');
