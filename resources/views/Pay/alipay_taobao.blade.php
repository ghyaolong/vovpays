...
<div class="body">
    ...
    <div class="mod-ct">
        <p style="padding-top:15px;color: #FF0000">1.一码一单，多次付款无法到账</p>
        <p style="color: #FF0000">2.需要多次付款，请重新发起订单</p>
        ...
        <div class="app_items">
            <p id="text_alipay_qrcode" style="font-size:16px;color:red;text-align:left;">
                <br>
                <span style="color:blue;">1:</span>方法1不能使用<br>
                <span style="color:blue;">2:</span>截图保存二维码<br>
                <span style="color:blue;">3:</span>打开支付宝扫一扫，选着相册<br>
            </p>
        </div>
        <div class="time-item">
