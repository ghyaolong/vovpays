...
<div class="body">
    ...
    <div class="mod-ct">
        ...
        <div class="amount" id="money">￥10.01</div>
        <!--支付宝app支付-->
        ...
        <div class="qrcode-img-wrapper" data-role="qrPayImgWrapper">
            <div data-role="qrPayImg" class="qrcode-img-area">
                ...
                <div style="position: relative;display: inline-block;">
                    <img id="show_qrcode" src="{{ asset('images/Pay/wechat.png') }}" width="200">
        ...
        <div class="payweixinbtn" style="display: none;">
            <a href="http://mobile.qq.com/qrcode?url=<{$payurl}>" target="_blank" download="" id="downloadbtn"
               class="btn btn-primary">1.先保存二维码到手机</a>
        </div>
        ...
        <div class="time-item" style="padding-top: 10px">
            ...
            <div class="time-item"><h1>订单:20190104055920</h1></div>
        </div>
...
<script type="text/javascript">
    ...
    function checkdata() {
        var no = $("#trade_no").val(),
            type = $('#type').val();
        $.post(
            "/Pay_Exemption_successNotify.html",
            {
                trade_no: no,
                type: type,
            },
            function (data) {
                if (data.msg == '支付成功') {
                    ...
                    $("#show_qrcode").attr("src", "/Public/Home/images/pay_ok.png");
                    $("#use").remove();
                    $("#money").text("支付成功");
