...
#Routine body goes here...
    ...
    read_loop: LOOP
         ...
         END IF;
				 ...
				 ELSE
					 INSERT INTO pay_order_day_counts(user_id,agent_id,  merchant_amount,merchant_income,merchant_order_count,merchant_order_suc_count,  sys_amount,sys_income,sys_order_count,sys_order_suc_count,created_at,updated_at) 
					 VALUES(uid,uparentId,  dmerchant_amount,dmerchant_income,dmerchant_order_count,dmerchant_order_suc_count,  dsys_amount,dsys_income,dsys_order_count,dsys_order_suc_count,TO_DAYS(DATE_SUB(CURDATE(),INTERVAL 1 DAY)),TO_DAYS(DATE_SUB(CURDATE(),INTERVAL 1 DAY))) ;
				 END IF;
