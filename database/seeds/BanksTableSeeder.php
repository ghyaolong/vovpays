...
class BanksTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('banks')->insert([
            ...
            ['code' => 'BJB', 'bankName' => '北京银行', 'ico' => 'bjb.png', 'status' => '1', 'created_at'=> $now, 'updated_at'=> $now],
            ...
            ['code' => 'SPAB', 'bankName' => '平安银行', 'ico' => 'spab.png', 'status' => '1', 'created_at'=> $now, 'updated_at'=> $now],
            ['code' => 'SHB', 'bankName' => '上海银行', 'ico' => 'shb.png', 'status' => '1', 'created_at'=> $now, 'updated_at'=> $now],
